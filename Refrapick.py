...
class Refrapick(Tk):
    ...
    def __init__(self):
        ...
        self.ico_previousWf = PhotoImage(
            file="%s/images/voltar.gif" % getcwd())
        ...
        self.ico_wiggles = PhotoImage(
            file="%s/images/fill_null.gif" %
            getcwd())
        ...
        self.ico_filters = PhotoImage(
            file="%s/images/ico_filter.gif" %
            getcwd())
        self.ico_pick = PhotoImage(file="%s/images/pick.gif" % getcwd())
        self.ico_connectPick = PhotoImage(
            file="%s/images/ligar.gif" % getcwd())
        self.ico_clearPicks = PhotoImage(
            file="%s/images/limpar.gif" % getcwd())
        ...
        self.ico_newProject = PhotoImage(
            file="%s/images/ico_newProject.gif" %
            getcwd())
        self.ico_loadProject = PhotoImage(
            file="%s/images/ico_loadProject.gif" %
            getcwd())
        self.ico_resample = PhotoImage(
            file="%s/images/ico_resample.gif" %
            getcwd())
        self.ico_survey = PhotoImage(
            file="%s/images/ico_survey.gif" %
            getcwd())
        self.ico_shotTime = PhotoImage(
            file="%s/images/ico_shotTime.gif" %
            getcwd())
        self.ico_loadPicks = PhotoImage(
            file="%s/images/ico_loadPicks.gif" %
            getcwd())
        self.ico_allPicks = PhotoImage(
            file="%s/images/ico_allPicks.gif" %
            getcwd())
        self.ico_restoreTraces = PhotoImage(
            file="%s/images/ico_restoreTraces.gif" %
            getcwd())
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_newProject,
            command=self.createProject,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_loadProject,
            command=self.loadProject,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_openWaveform,
            command=self.openWaveform)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_previousWf,
            command=self.previousSection,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_nextWf,
            command=self.nextSection,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_zoomY,
            command=self.yLimDown,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_moreGain,
            command=self.addGain,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_lessGain,
            command=self.removeGain,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_fillNeg,
            command=self.fillPositive,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_fillPos,
            command=self.fillNegative,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_wiggles,
            command=self.wigglesOnly,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_shotTime,
            command=self.correctShotTime,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_resample,
            command=self.resampleTraces,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_invertY,
            command=self.invertTimeAxis,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_restoreTraces,
            command=self.restoreTraces,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_connectPick,
            command=self.drawPicksLine,
            width=25)
        ...
        bt = Button(
            frame_toolbar,
            image=self.ico_clearPicks,
            command=self.clearPicks,
            width=25)
    ...
    def kill(self):
        ...
        out = messagebox.askyesno(
            "Refrapick", "Do you want to close the software?")
        ...
        if self.sts:
            ...
            if messagebox.askyesno("Refrapick", "Clear all?"):
                ...
                self.statusLabel.configure(
                    text="Create or load a project to start", font=(
                        "Arial", 11))
                messagebox.showinfo(
                    title="Refrapick",
    ...
    def plotOptions(self):
        ...
        def editTraceColor():
            ...
            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new trace color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The trace color has been changed")
                plotOptionsWindow.tkraise()

            else:
                messagebox.showerror(
                    title="Refrapick", message="Invalid color!")
                plotOptionsWindow.tkraise()

        def editFillColor():

            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new fill color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                if self.sts:
                    ...
                    for i in range(len(self.sts)):
                        ...
                        if self.fillSide[i] == 1:
                            self.wigglesOnly()
                            self.fillPositive()
                        elif self.fillSide[i] == -1:
                            self.wigglesOnly()
                            self.fillNegative()

                messagebox.showinfo(
                    title="Refrapick",
                    message="The fill color has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editBackgroundColor():
            ...
            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new background color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The plot background color has been changed")
                plotOptionsWindow.tkraise()
            ...
            if self.grid:
                ...
                if messagebox.askyesno("Refrapick", "Disable grid?"):
                    ...
                    if self.sts:
                        ...
                        messagebox.showinfo(
                            title="Refrapick", message="The grid lines have been disabled")
                ...
                if messagebox.askyesno("Refrapick", "Enable grid?"):
                    ...
                    if self.sts:
                        ...
                        for i in range(len(self.sts)):
                            ...
                            self.axs[i].grid(
                                lw=.5, alpha=.5, c=self.gridColor, ls=self.gridStyle)
                            self.figs[i].canvas.draw()

                        messagebox.showinfo(
                            title="Refrapick", message="The grid lines have been enabled")
        ...
        def editGridStyle():
            ...
            new_style = simpledialog.askstring(
                "Refrapick", "Enter the new grid line style (must be accepted by matplotlib):")
            ...
            if new_style in lines.lineStyles.keys():
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The grid line style has been changed")
                plotOptionsWindow.tkraise()

            else:
                messagebox.showerror(
                    title="Refrapick",
                    message="Invalid line style!")
                plotOptionsWindow.tkraise()

        def editGridColor():

            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new grid line color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The grid line color color has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editPickColor():
            ...
            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new pick marker color (must be accepted by matplotlib):")
                    ...
                    for i in range(len(self.sts)):
                        ...
                        if self.xpicks[i]:
                            ...
                            for pickArt in self.picksArts[i]:
                                pickArt.set_color(self.pickColor)

                        self.figs[i].canvas.draw()

                messagebox.showinfo(
                    title="Refrapick",
                    message="The pick marker color has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editPickMarker():
            ...
            new_marker = simpledialog.askstring(
                "Refrapick", "Enter the new pick marker style (must be accepted by matplotlib):")

            if new_marker in markers.MarkerStyle.markers.keys():

                new_size = simpledialog.askfloat(
                    "Refrapick", "Enter the new pick marker size:")

                if new_size:

                    self.pickSize = new_size
                    # markers.MarkerStyle(new_marker)
                    self.pickMarker = new_marker
                    ...
                    messagebox.showinfo(
                        title="Refrapick",
                        message="The pick marker style has been changed")
                    plotOptionsWindow.tkraise()

            else:
                messagebox.showerror(
                    title="Refrapick", message="Invalid marker!")
                plotOptionsWindow.tkraise()

        def editPickLineColor():

            new_color = simpledialog.askstring(
                "Refrapick", "Enter the new pick line color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The pick line color has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editPickLineStyle():
            ...
            new_style = simpledialog.askstring(
                "Refrapick", "Enter the new pick line style (must be accepted by matplotlib):")
            ...
            if new_style in lines.lineStyles.keys():
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The pick line style has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editTraveltimeLineColor():
            ...
            new_color = simpledialog.askstring(
                "Refrapick",
                "Enter the new traveltimes line color (must be accepted by matplotlib):")
            ...
            if is_color_like(new_color):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The traveltimes line color has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editTraveltimeLineStyle():
            ...
            new_style = simpledialog.askstring(
                "Refrapick",
                "Enter the new traveltimes line style (must be accepted by matplotlib):")
            ...
            if new_style in lines.lineStyles.keys():
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The traveltimes line style has been changed")
                plotOptionsWindow.tkraise()
        ...
        def editrGainFactor():
            ...
            new_gainFactor = simpledialog.askfloat(
                "Refrapick", "Enter the new gain factor (default is 3):")
            ...
            if new_gainFactor:
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="The gain factor has been changed")
        ...
        Button(
            plotOptionsWindow,
            text="Change trace color",
            command=editTraceColor,
            width=30).grid(
            row=1,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Enable/disable grid lines",
            command=gridOnOff,
            width=30).grid(
            row=4,
            column=0,
        ...
        Button(
            plotOptionsWindow,
            text="Change grid lines style",
            command=editGridStyle,
            width=30).grid(
            row=5,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change pick color",
            command=editPickColor,
            width=30).grid(
            row=7,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change pick marker",
            command=editPickMarker,
            width=30).grid(
            row=8,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change pick line color",
            command=editPickLineColor,
            width=30).grid(
            row=9,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change pick line style",
            command=editPickLineStyle,
            width=30).grid(
            row=10,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change traveltimes line color",
            command=editTraveltimeLineColor,
            width=30).grid(
            row=11,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change traveltimes line style",
            command=editTraveltimeLineStyle,
            width=30).grid(
            row=12,
            column=0,
            pady=5,
        ...
        Button(
            plotOptionsWindow,
            text="Change scale gain factor",
            command=editrGainFactor,
            width=30).grid(
            row=13,
            column=0,
            pady=5,
    ...
    def options(self):
        ...
        if self.sts:
            ...
            def editdx():
                ...
                if new_dx is not None:
                    ...
                    if new_dx > 0:
                        ...
                        self.receiverPositions[self.currentSt] = [
                            i / self.dxs[self.currentSt] for i in self.receiverPositions[self.currentSt]]
                        self.xends[self.currentSt] = self.xends[self.currentSt] / \
                        ...
                        for i in range(len(self.tracesArts[self.currentSt])):
                            ...
                            self.tracesArts[self.currentSt][i].set_xdata(
                                a / max(a) * self.gains[self.currentSt] + self.x1s[self.currentSt] + self.dxs[self.currentSt] * i)

                        self.axs[self.currentSt].set_xlim(
                            self.x1s[self.currentSt] - self.dxs[self.currentSt] / 2, self.xends[self.currentSt] + self.dxs[self.currentSt] / 2)
                        ...
                        messagebox.showinfo(
                            title="Refrapick", message="The receiver spacing was updated in %s" % self.stNames[self.currentSt])
                        optionsWindow.tkraise()

                    else:
                        messagebox.showerror(
                            title="Refrapick", message="Invalid dx value!")

            def editx1():

                new_x1 = simpledialog.askfloat(
                    "Refrapick", "Enter the new position for the first receiver in meters (for %s):" % self.stNames[self.currentSt])
                ...
                if new_x1:
                    ...
                    self.receiverPositions[self.currentSt] = [
                        i + new_x1 for i in self.receiverPositions[self.currentSt]]
                    ...
                    self.axs[self.currentSt].set_xlim(self.x1s[self.currentSt] -
                                                      self.dxs[self.currentSt] /
                                                      2, self.xends[self.currentSt] +
                                                      self.dxs[self.currentSt] /
                                                      2)
                    ...
                    self.figs[self.currentSt].canvas.draw()
                    messagebox.showinfo(
                        title="Refrapick", message="The position of the first receiver was updated in %s" % self.stNames[self.currentSt])
                    optionsWindow.tkraise()

            def editsource():

                new_source = simpledialog.askfloat(
                ...
                if new_source is not None:
                    ...
                    self.updatePlotTitle()
                    messagebox.showinfo(
                        title="Refrapick", message="The source position was updated in %s" % self.stNames[self.currentSt])
                    optionsWindow.tkraise()
            ...
            Label(optionsWindow,
                  text="Editing parameters in %s" % self.stNames[self.currentSt],
                  font=("Arial",
                        11)).grid(row=0,
                                  column=0,
                                  sticky="EW",
            ...
            Button(
                optionsWindow,
                text="Edit first receiver position",
                command=editx1,
                width=30).grid(
                row=2,
                column=0,
    ...
    def correctShotTime(self):
        ...
        if self.sts:
            ...
            delay = simpledialog.askfloat(
                "Refrapick", "Enter the delay time in seconds to correct shot time:")
            ...
            if delay:
                ...
                for i in range(len(self.sts)):
                    ...
                    for j in range(len(self.tracesArts[self.currentSt])):
                        ...
                        self.tracesArts[i][j].set_ydata(
                            self.tracesTime[i][j] + delay)
                        self.tracesTime[i][j] += delay

                    if self.invertedTimeAxis[i] == 0:
                        self.axs[i].set_ylim(
                            min(self.tracesTime[i][0]), max(self.tracesTime[i][0]))
                    else:
                    ...
                    if self.amplitudeClip[i] == 1:
                        self.amplitudeClip[i] = 0
                        self.clipAmplitudes()

                messagebox.showinfo(
                    title="Refrapick",
                    message="Shot time has been corrected for all opened waveforms!")
    ...
    def createProject(self):
        ...
        if self.projPath:
            ...
            projName = simpledialog.askstring(
                "Refrapick", "Enter the name of the project to be created:")
            ...
            if not path.exists(self.projPath + "/" + projName):
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="A project was detected, please choose another name or directory!")
    ...
    def loadProject(self):
        ...
        if self.projPath:
            ...
            if path.exists(self.projPath + "/" + "data") and \
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="Successfully loaded the project path!")
                self.statusLabel.configure(
                    text="Project path ready!", font=(
                        "Arial", 11))
            ...
            if files:
                ...
                for i, file in enumerate(files):
                    ...
                    if st[0].stats._format == "SEG2":
                        ...
                        dx = float(st[1].stats.seg2['RECEIVER_LOCATION']) - \
                        ...
                        dx = simpledialog.askfloat(
                            "Refrapick",
                            "Enter the receiver spacing (in meters) for %s:" %
                            path.basename(file))
                        ...
                        if dx is None or dx <= 0:
                            ...
                            messagebox.showinfo(
                                'Refrapick',
                                'No valid dx entered: dx = 1 m will be assigned to %s' %
                                path.basename(file))

                        x1 = simpledialog.askfloat(
                            "Refrapick",
                            "Enter the first receiver position (in meters) for %s:" %
                            path.basename(file))
                        ...
                        if x1 is None:
                            ...
                            messagebox.showinfo(
                                'Refrapick',
                                'No x1 value entered: x1 = 0 m will be assigned to %s' %
                                path.basename(file))

                        source = simpledialog.askfloat(
                            "Refrapick", "Enter the source position (in meters) for %s:" %
                            path.basename(file))
                        ...
                        if source is None:
                            ...
                            messagebox.showinfo(
                                'Refrapick',
                                'No source value entered: source = -1 m will be assigned to %s' %
                                path.basename(file))

                        delay = simpledialog.askfloat(
                            "Refrapick",
                            "Enter the delay for shot time correction (in seconds) for %s:" %
                            path.basename(file))
                        ...
                        if delay is None:
                            ...
                            messagebox.showinfo(
                                'Refrapick',
                                'No delay time entered: delay = 0 s will be used for %s' %
                                path.basename(file))
                    ...
                    self.samplingRates.append(
                        int(st[0].stats['sampling_rate']))
                    self.originalSamplingRates.append(
                        int(st[0].stats['sampling_rate']))
                    ...
                    ax.set_title(
                        path.basename(file) +
                        " | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = no" %
                        (dx,
                         source,
                         self.originalSamplingRates[i]))
                    self.stNames.append(path.basename(file))
                    ax.set_ylim(min(tr.times() + delay),
                                max(tr.times() + delay))
                ...
                if n == 0:
                    messagebox.showinfo(
                        'Refrapick',
                        '%d file(s) loaded succesfully!' %
                        len(files))
                else:
                    messagebox.showinfo(
                        'Refrapick',
                        '%d new file(s) loaded succesfully!' %
                        len(files))
...
""", font=("Arial", 11)).pack()
    ...
    def viewSurvey(self):
        ...
        if self.sts:
            ...
            for i in range(len(self.sts)):
                ...
                ax.plot(
                    self.receiverPositions[i], [
                        self.stNames[i]] * self.nchannels[i], "-v", c="k")
                ax.scatter(
                    self.sources[i],
                    self.stNames[i],
                    marker="*",
    ...
    def invertTimeAxis(self):
        ...
        if self.sts:
            ...
            if self.invertedTimeAxis[self.currentSt] == 1:
                self.invertedTimeAxis[self.currentSt] = 0
            else:
                self.invertedTimeAxis[self.currentSt] = 1

            self.figs[self.currentSt].canvas.draw()

    def updatePlotTitle(self):

        if self.filters[self.currentSt][1] and self.filters[self.currentSt][0]:
            self.axs[self.currentSt].set_title("%s | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = %.2f Hz - %.2f Hz" % (self.stNames[self.currentSt],
        ...
        elif self.filters[self.currentSt][1] and not self.filters[self.currentSt][0]:
            self.axs[self.currentSt].set_title("%s | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = %.2f Hz (low-pass)" % (
                self.stNames[self.currentSt], self.dxs[self.currentSt], self.sources[self.currentSt], self.samplingRates[self.currentSt], self.filters[self.currentSt][1]))

        elif self.filters[self.currentSt][0] and not self.filters[self.currentSt][1]:
            self.axs[self.currentSt].set_title("%s | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = %.2f Hz (high-pass)" % (
                self.stNames[self.currentSt], self.dxs[self.currentSt], self.sources[self.currentSt], self.samplingRates[self.currentSt], self.filters[self.currentSt][0]))
        else:
            self.axs[self.currentSt].set_title("%s | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = no" % (
                self.stNames[self.currentSt], self.dxs[self.currentSt], self.sources[self.currentSt], self.samplingRates[self.currentSt]))
        self.figs[self.currentSt].canvas.draw()
    ...
    def resampleTraces(self):
        ...
        if self.sts:
            ...
            newSamplingFreq = simpledialog.askinteger(
                "Refrapick", "Enter the new sampling frequency (current = %d Hz):" % self.samplingRates[self.currentSt])
            ...
            if newSamplingFreq:
                ...
                if newSamplingFreq >= 100:
                    ...
                    for i, tr in enumerate(self.tracesData[self.currentSt]):
                        ...
                        new_data, new_time = resample(
                            tr, n, self.tracesTime[self.currentSt][i])
                        self.tracesData[self.currentSt][i] = new_data
                        self.tracesTime[self.currentSt][i] = new_time
                        self.tracesArts[self.currentSt][i].set_xdata(
                            new_data / max(new_data) * self.gains[self.currentSt] + self.x1s[self.currentSt] + self.dxs[self.currentSt] * i)
                    ...
                    messagebox.showerror(
                        'Refrapick', 'Enter a value greater or equal than 100 Hz!')

    def trimTraces(self):

        if self.sts:

            maxTime = simpledialog.askfloat(
                "Refrapick", "Enter the new maximum time:")
            ...
            if maxTime:
                ...
                for i in range(len(self.tracesArts[self.currentSt])):
                    ...
                    self.tracesArts[self.currentSt][i].set_xdata(self.tracesData[self.currentSt][i] / max(
                        self.tracesData[self.currentSt][i]) * self.gains[self.currentSt] + self.x1s[self.currentSt] + self.dxs[self.currentSt] * i)
                    self.tracesArts[self.currentSt][i].set_ydata(
                        self.tracesTime[self.currentSt][i])
        ...
        if self.sts:
            ...
            if self.amplitudeClip[self.currentSt] == 0:
                ...
                for i, tr in enumerate(self.tracesArts[self.currentSt]):
                    ...
                    tr.get_xdata()[tr.get_xdata() < self.x1s[self.currentSt] + i * self.dxs[self.currentSt] - ((self.dxs[self.currentSt] / 2)
                                                                                                               * 0.9)] = self.x1s[self.currentSt] + i * self.dxs[self.currentSt] - ((self.dxs[self.currentSt] / 2) * 0.9)
                    tr.get_xdata()[tr.get_xdata() > self.x1s[self.currentSt] + i * self.dxs[self.currentSt] + ((self.dxs[self.currentSt] / 2)
                                                                                                               * 0.9)] = self.x1s[self.currentSt] + i * self.dxs[self.currentSt] + ((self.dxs[self.currentSt] / 2) * 0.9)
    ...
    def fillNegative(self):
        ...
        if self.sts:
            ...
            if self.fillSide[self.currentSt] == - \
                    1 or self.fillSide[self.currentSt] == 1:
            ...
            for i in range(len(self.sts[self.currentSt])):
                ...
                fill = self.axs[self.currentSt].fill_betweenx(self.tracesArts[self.currentSt][i].get_ydata(),
                                                              self.x1s[self.currentSt] +
                                                              self.dxs[self.currentSt] * i,
                                                              self.tracesArts[self.currentSt][i].get_xdata(
                ),
                    where=self.tracesArts[self.currentSt][i].get_xdata(
                ) <= self.x1s[self.currentSt] + i * self.dxs[self.currentSt],
    ...
    def addGain(self):
        ...
        if self.sts:
            ...
            for i in range(len(self.tracesArts[self.currentSt])):
                ...
                self.tracesArts[self.currentSt][i].set_xdata(self.tracesData[self.currentSt][i] /
                                                             max(self.tracesData[self.currentSt][i]) *
                                                             self.gains[self.currentSt] +
                                                             self.x1s[self.currentSt] +
                                                             self.dxs[self.currentSt] *
                                                             i)
    ...
    def removeGain(self):
        ...
        if self.sts:
            ...
            if self.gains[self.currentSt] - self.gainFactor >= 1:
                self.gains[self.currentSt] -= self.gainFactor
    ...
    def applyFilters(self):
        ...
        if self.sts:
            ...
            hp = simpledialog.askfloat(
                "Refrapick", "Frequency limit for high pass filter (cancel for none):")
            ...
            if hp:
                ...
                if hp < 0:
                    ...
                    messagebox.showinfo(
                        'Refrapy',
                        'A negative high pass value is not valid: 0.1 Hz will be used instead')
                    hp = 0.1

                elif hp > self.samplingRates[self.currentSt] / 2:

                    messagebox.showinfo('Refrapy', 'Invalid high pass value: greater than the Nyquist limit, %.2f Hz will be used instead' % (
                        -1 + self.samplingRates[self.currentSt] / 2))
                    hp = -1 + self.samplingRates[self.currentSt] / 2

            lp = simpledialog.askfloat(
                "Refrapick", "Frequency limit for low pass filter (cancel for none):")

            if lp:

                if lp > self.samplingRates[self.currentSt] / 2:

                    messagebox.showinfo('Refrapy', 'Invalid low pass value: greater than the Nyquist limit, %.2f Hz will be used instead' % (
                        self.samplingRates[self.currentSt] / 2))
            ...
            if lp:
                ...
                for i, data in enumerate(self.tracesData[self.currentSt]):
                    ...
                    self.tracesData[self.currentSt][i] = lowpass(
                        data, lp, self.samplingRates[self.currentSt])
            ...
            if hp:
                ...
                for i, data in enumerate(self.tracesData[self.currentSt]):
                    ...
                    self.tracesData[self.currentSt][i] = highpass(
                        data, hp, self.samplingRates[self.currentSt])
    ...
    def restoreTraces(self):
        ...
        if self.sts:
            ...
            if messagebox.askyesno(
                    "Refrapick", "Restore default traces in %s?" % self.stNames[self.currentSt]):
                ...
                self.axs[self.currentSt].set_title("%s | dx = %.2f m | source = %.2f m | sampling = %d Hz | filters = no" % (
                    self.stNames[self.currentSt], self.dxs[self.currentSt], self.sources[self.currentSt], self.originalSamplingRates[self.currentSt]))

                if self.invertedTimeAxis[self.currentSt] == 1:

                    self.axs[self.currentSt].set_ylim(max(self.originalTracesTimes[self.currentSt][0]), min(
                        self.originalTracesTimes[self.currentSt][0]))

                else:
                    self.axs[self.currentSt].set_ylim(min(self.originalTracesTimes[self.currentSt][0]), max(
                        self.originalTracesTimes[self.currentSt][0]))
    ...
    def pick(self):
        ...
        if self.sts:
            ...
            if not self.pickMode:
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="Pick mode enabled")

                def createPick(x, t):

                    for j in range(len(x)):

                        pickline = self.axs[self.currentSt].scatter(
                            x[j], t[j], marker=self.pickMarker, s=self.pickSize * self.dxs[self.currentSt], color=self.pickColor)
                ...
                def click1(event):
                    ...
                    if event.button == 1:
                        ...
                        if x not in self.xpicks[self.currentSt]:
                            createPick([x], [event.ydata])
                        else:
                            reworkPick([x], [event.ydata])
                ...
                def release(event):
                    ...
                    if self.click2on:
                        ...
                        if self.xpickLine[0] < x:
                            ...
                            f = interp1d([self.xpickLine[0], x], [
                                         self.tpickLine[0], event.ydata], kind="linear")
                            xarray2pick = [
                                j for j in self.receiverPositions[self.currentSt] if j >= self.xpickLine[0] and j <= x]

                        else:

                            f = interp1d([x, self.xpickLine[0]], [
                                         event.ydata, self.tpickLine[0]], kind="linear")
                            xarray2pick = [
                                j for j in self.receiverPositions[self.currentSt] if j >= x and j <= self.xpickLine[0]]
                        ...
                        for j, x in enumerate(xarray2pick):
                            ...
                            if x not in self.xpicks[self.currentSt]:
                                xpicks2create.append(x)
                                tpicks2create.append(tarray2pick[j])
                            else:
                                xpicks2rework.append(x)
                                tpicks2rework.append(tarray2pick[j])

                        if xpicks2create:
                            createPick(xpicks2create, tpicks2create)
                        if xpicks2rework:
                            reworkPick(xpicks2rework, tpicks2rework)
                ...
                for i in range(len(self.sts)):
                    ...
                    conMove = self.figs[i].canvas.mpl_connect(
                        'motion_notify_event', move)
                    conRelease = self.figs[i].canvas.mpl_connect(
                ...
                self.pickMode = False
                self.statusLabel.configure(
                    text="Pick mode disabled!", font=(
                        "Arial", 11))
                messagebox.showinfo(
                    title="Refrapick",
                    message="Pick mode disabled!")
    ...
    def drawPicksLine(self):
        ...
        if self.sts:
            ...
            if self.xpicks[self.currentSt]:
                ...
                if not self.pickLineArts[self.currentSt]:
                    ...
                    line, = self.axs[self.currentSt].plot(
                        sortedx, sortedt, c=self.pickLineColor, lw=.7)
    ...
    def savePicks(self):
        ...
        if self.sts:
            ...
            if not pickPresent:
                messagebox.showerror(
                    title="Refrapick",
                    message="There are no picks to be exported!")

            else:

                if messagebox.askyesno(
                        "Refrapick", "Load a topography file (x,z)?"):
                    ...
                    if elevFile:
                        ...
                        f = interp1d(xtopo, ztopo, kind="cubic", fill_value=(
                            ztopo[0], ztopo[-1]), bounds_error=False)  # , fill_value="extrapolate")
                        sgz = f(sgx)
                        ...
                        if pickFile:
                            ...
                            with open(pickFile + ".sgt", "w") as outFile:
                                ...
                                for i in range(len(self.sts)):
                                    nMeasurements += len(self.xpicks[i])
                                ...
                                for i in range(len(self.sts)):
                                    ...
                                    for xpick, tpick in zip(
                                            sortedxpicks, sortedtpicks):

                                        # s = where(sgx == self.sources[i])[0][0]+1
                                        # g = where(sgx == xpick)[0][0]+1
                                        s = isclose(
                                            array(sgx), array(
                                                self.sources[i])).nonzero()[0] + 1
                                        g = isclose(
                                            array(sgx), array(xpick)).nonzero()[0] + 1
                                        t = tpick
                                        outFile.write(
                                            "%d %d %.6f\n" %
                                            (s, g, t))
    ...
    def clearPicks(self):
        ...
        if self.sts:
            ...
            if messagebox.askyesno(
                    "Refrapick", "Clear picks in %s?" % self.stNames[self.currentSt]):
                ...
                if self.xpicks[self.currentSt]:
                    ...
                    for pickArt in self.picksArts[self.currentSt]:
                        pickArt.remove()
                    ...
                    self.figs[self.currentSt].canvas.draw()
                    messagebox.showinfo(
                        title="Refrapick", message="All picks in %s have been deleted!" % self.stNames[self.currentSt])
        ...
        if self.sts:
            ...
            if pickFile:
                ...
                with open(pickFile, "r") as file:
                    ...
                    for i in range(len(self.sts)):
                        ...
                        for j in range(len(sx)):
                            ...
                            if self.sources[i] == sx[j] and gx[j] in self.receiverPositions[i]:
                                ...
                                pickline = self.axs[i].hlines(
                                    t[j], gx[j] - (self.dxs[i] * 0.25), gx[j] + (self.dxs[i] * 0.25), color='r')
                                self.picksArts[i].append(pickline)
                    ...
                    if loaded:
                        messagebox.showinfo(
                            title="Refrapick", message="The pick file has been loaded!")
                    else:
                        messagebox.showerror(
                            title="Refrapick",
                            message="The pick file was not loaded: check if you have selected the correct pick file for the opened waveforms!")
                ...
                if len(self.ttArts) == 0:
                    ...
                    for i in range(len(self.sts)):
                        ...
                        if self.currentSt != i:
                            ...
                            sortedxpicks = array(self.xpicks[i])[xinds]
                            sortedtpicks = array(self.tpicks[i])[xinds]
                            l, = self.axs[self.currentSt].plot(
                                sortedxpicks, sortedtpicks, ls=self.traveltimesStyle, lw=.7, c=self.traveltimesColor)
                            self.ttArts.append(l)

                else:

                    for ttPlot in self.ttArts:
                        ttPlot.remove()
                    del self.ttArts[:]
    ...
    def appVelMode(self):
        ...
        if self.sts:
            ...
            if not self.velMode:
                ...
                messagebox.showinfo(
                    title="Refrapick",
                    message="Apparent velocity mode enabled")
                    ...
                    def click(event):
                        ...
                        if event.button == 1:
                            ...
                            x = min(
                                ...
                                key=lambda x: abs(
                                    event.xdata - x))
                            self.velLine, = self.axs[self.currentSt].plot(
                                x, event.ydata, c="b", ls="--", lw=.7)
                            self.xvelLine = [x]
                    ...
                    def release(event):
                        ...
                        if self.clickon:
                            ...
                            if self.xvelLine[0] < x:
                                ...
                                f = interp1d([self.xvelLine[0], x], [
                                             self.tvelLine[0], event.ydata], kind="linear")
                                xarray2vel = [
                                    j for j in self.receiverPositions[i] if j >= self.xvelLine[0] and j <= x]

                            else:

                                f = interp1d([x, self.xvelLine[0]], [
                                             event.ydata, self.tvelLine[0]], kind="linear")
                                xarray2vel = [
                                    j for j in self.receiverPositions[i] if j >= x and j <= self.xvelLine[0]]

                            tarray2vel = f(xarray2vel)
                            self.velLine.set_data(xarray2vel, tarray2vel)
                            m, b = polyfit(xarray2vel, tarray2vel, 1)
                            txt = self.axs[self.currentSt].text(
                                xarray2vel[0], tarray2vel[0], "%d m/s" % (abs(1 / m)), backgroundcolor="w")
                            self.velTexts.append(txt)
                            self.clickon = False
                            self.figs[self.currentSt].canvas.draw()

                    self.clickon = False
                    conClick = self.figs[i].canvas.mpl_connect(
                ...
                for i in range(len(self.sts)):
                    ...
                    for l in self.velLines:
                        l.remove()
                    for t in self.velTexts:
                        t.remove()
                    del self.velLines[:]
                    del self.velTexts[:]
                    del self.xvelLine[:]
                    del self.tvelLine[:]
                    self.clickon = False
                    for con in self.velConnections[i]:
                        self.figs[i].canvas.mpl_disconnect(con)
                ...
                self.velMode = False
                self.statusLabel.configure(
                    text="Apparent velocity mode disabled!", font=(
                        "Arial", 11))
                messagebox.showinfo(
                    title="Refrapick",
                    message="Apparent velocity mode disabled!")
